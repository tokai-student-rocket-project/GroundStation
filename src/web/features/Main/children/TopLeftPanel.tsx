      ...
      <div className="level-item has-text-centered ">
        <div>
          ...
          <div className="is-flex is-align-items-end">
            <p className="title has-text-light">0.00</p>
            <p className="subtitle has-text-light mx-2">m</p>
          </div>
        </div>
      </div>
      <div className="level-item has-text-centered">
        <div>
          ...
          <div className="is-flex is-align-items-end">
            <p className="title has-text-light">0.00</p>
            <p className="subtitle has-text-light mx-2">m/s</p>
          </div>
        </div>
      </div>
      <div className="level-item has-text-centered">
        <div>
          ...
          <div className="is-flex is-align-items-end">
            <p className="title has-text-light">0.00</p>
            <p className="subtitle has-text-light mx-2">
              m/s
